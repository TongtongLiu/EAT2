...
public class CircleBar extends View {
    ...
    public void setPressed(boolean pressed) {
        ...
        if (pressed) {
        	...
        	mColorWheelPaint.setColor(mColorWheelColor);
...
//	
	...
	public void setColorWheelColor(int color){
		mColorWheelColor = color;
	}
	...
	public void setPressWidth(int width){
		//mPressWidth = width;
		pressExtraStrokeWidth = width;
	}
...
//	
    ...
    public void updateColor(int mCount){
    	
    	int colors[] = {0xFF9CE800, 0xFFC3F300, 0xFFCFDC00, 0xFFF3ED00, 0xFFE8DA00, 
    			0xFFE8CC00, 0xFFF3CC00, 0xFFDCB000, 0xFFF3B900, 0xFFE8A800, 
    			0xFFE89900, 0xFFF39700, 0xFFDC8000, 0xFFF37F00, 0xFFE86D00, 
    			0xFFE85800, 0xFFF34E00, 0xFFDC3B00, 0xFFF33300, 0xFFE82400};
    	int color = 20 - (mCount / 5);
    	if(color >= 20) color = 19;
    	
    	/*
    	int colors[] = {0xFFE86D00, 0xFFE8A800, 0xFF9CE800};
    	int color = (mCount - 2) / 33;
    	if(color < 0) color = 0;
    	*/
    	mColorWheelPaint.setColor(colors[color]);
    }
