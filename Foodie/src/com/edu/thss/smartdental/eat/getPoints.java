...
public class getPoints {
    ...
    private static double[] miu = {800, 2000, 17.5, 350, 13, 0.75, 100, 0.005, 14, 
    	1.5, 1.7, 1.9, 0.0024, 85};
    private static double[] theta = {327.56, 547.49, 12.40, 104.5, 273.14, 1.41, 
    	250.71, 0.40, 221.12, 17.62, 17.56, 33.01, 0.83, 254.6};
    private static double[] beta = {5865, 9444, 222, 1871, 4890, 25, 4489, 7, 3959, 
    	316, 314, 591, 15, 4558}; 
    private static String[] Name = {"钙","钾","铁","镁","锌","维生素A","维生素C","维生素D",
    	"维生素E","维生素B1","维生素B2","维生素B6","维生素B12","蛋白质"};
    private static String[][] advice = {{"奶粉 ", "肉桂粉", "芝麻"},
    	{"萝卜干", "辣椒粉", "黄豆"}, {"孜然", "鸭肝", "鹅肝"}, {"南瓜子", "西瓜子", "芝麻"},
    	{"生蚝", "牛排", "西瓜子"},{"胡萝卜", "黄油", "南瓜"},{"辣椒", "猕猴桃", "西兰花"},
    	{"鲤鱼", "香菇", "鸡蛋"}, {"瓜子仁", "杏仁", "花生"}, {"羊肝", "香菇", "杏仁"},
    	{"辣椒粉", "瓜子仁", "开心果"}, {"鸭肝", "鹅肝", "绿豆"},{"羊肝", "牛肝", "鸭肝"},
    	{"猪皮", "冻豆腐", "黄豆"}};
